...
namespace RAG
{
    public class Utilities
    {
        ...
        /// <returns></returns>
        public static string CallGPT(string prompt, string? profileText = null, bool displayAnswer = false, bool displayPrompt = false, bool addToHistory = true)
        {
            // Setup
            // ---------------------------------------------------------------
        ...
        public static string GetDataSource(string question)
        {
            ...
            string answer = CallGPT(prompt: prompt, addToHistory: false);
            return answer;
        }
